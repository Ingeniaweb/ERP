...
//print '<option value="2" '.if($conf->global->CONSUMPTION_SEARCHMODE==2) 'selected'.'>'.$langs->trans("search2").'</option>';
//print '<option value="3" '.if($conf->global->CONSUMPTION_SEARCHMODE==3) 'selected'.'>'.$langs->trans("search3").'</option>';
print '</select></td>';
print '<td><input class="button" value="Modifier" name="Button" type="submit"></td>';
print "</tr></form>\n";
print '</table>';
