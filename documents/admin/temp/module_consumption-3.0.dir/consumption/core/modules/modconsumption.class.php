...
class modconsumption extends DolibarrModules
{
	...
	$langs->load("consumption@consumption");	
		...
		$this->description = "Consumption Management";
		...
		*/
		...
		//							'mainmenu'=>'consumption',
		//							'leftmenu'=>'1',		// Use 1 if you also want to add left menu entries using this descriptor.
		//							'url'=>'/consumption/pagetop.php',
		//							'langs'=>'consumption',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
