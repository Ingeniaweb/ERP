...
if($search_date_ini >0 && $fecha_factura=='checked'){
	...
	$sql.= " AND c.date_commande >= '".$search_date_ini."' AND c.date_commande <='".$search_date_fin."'";
}

if($search_date_lim_ini >0 && $fecha_vencimiento=='checked'){

	$sql.= " AND  c.date_livraison >= '".$search_date_lim_ini."' AND  c.date_livraison <='".$search_date_lim_fin."'";
}
